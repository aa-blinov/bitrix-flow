    ...
    <div className="flex flex-col bg-background">
      ...
      >
        <div className="flex min-w-max gap-4 px-4 py-2 xl:gap-5">
          {allStages.map((stage) => <div key={stage.id} className="h-px w-[32rem] xl:w-[36rem]" />)}
          {orphanTasks.length > 0 && <div className="h-px w-[32rem] xl:w-[36rem]" />}
        </div>
      </div>
        ...
        <div className="flex h-full min-w-max gap-4 px-4 py-6 xl:gap-5">
          {allStages.map((stage: any) => {
            ...
            return (
              <Card
                key={stage.id}
                className={`w-[20rem] flex-shrink-0 gap-0 py-0 transition-colors lg:w-[32rem] xl:w-[36rem] ${
          ...
          {orphanTasks.length > 0 && (
            <Card
              className="w-[20rem] flex-shrink-0 gap-0 py-0 border-dashed opacity-80 lg:w-[32rem] xl:w-[36rem]"
