...
function convertBxTask(bxTask: Bx24Task): BxTask {
  return {
    ...
    assigneeId: bxTask.responsibleId || bxTask.responsible?.id || '',
    assigneeName: bxTask.responsibleName || bxTask.responsible?.name || '',
    assigneeAvatar: bxTask.responsibleIcon || bxTask.responsible?.icon,
